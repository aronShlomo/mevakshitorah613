...
<div class="account_signup">
    ...
    <div class="account-fileds-signup">
        <input type="text" placeholder="First Name" name="firstname" class="form-control account-text">
        <input type="text" placeholder="Last Name " name="Lastname" class="form-control account-text">
